...
public class CakarKucingActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_cakar_kucing);
		...
		kisikisi.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Toast.makeText(getApplicationContext(), "CAKAR KUCING", Toast.LENGTH_LONG).show();
			}
		});
	...
	public void cekjawaban(View v){
		String jawabanBenar = "CAKAR KUCING";
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent trans = new Intent(getApplicationContext(),CumaSinisActivity.class);
			startActivity(trans);
			jawaban.setText("");
			finish();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		inflater.inflate(R.menu.cakar_kucing, menu);
