...
public class AngkatLautActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_angkat_laut);
		...
		kisikisi.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Toast.makeText(getApplicationContext(), "ANGKAT LAUT", Toast.LENGTH_LONG).show();
			}
		});
	...
	public void cekjawaban(View v){
		String jawabanBenar = "ANGKAT LAUT";
		...
		if(jawabanUser.equals(jawabanBenar)){
			...
			Intent trans = new Intent(getApplicationContext(),AlaskakiActivity.class);
			startActivity(trans);
			jawaban.setText("");
			finish();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		inflater.inflate(R.menu.angkat_laut, menu);
